...
const sortBackwards = (arr) => {
  arr.sort((oneNum, anotherNum) => {
    return anotherNum - oneNum;
  });
  return arr;
};
...
const alphabetize = (arr) => {
  arr.sort((oneString, anotherString) => {
    ...
    {
      return oneString > anotherString ? 1 : -1;
    }
  });
  return arr;
};
...
const sortByLength = (arr) => {
  arr.sort((oneString, anotherString) => {
    return oneString.length - anotherString.length;
  });
  return arr;
};
...
const alphabetizeBetter = (arr) => {
  arr.sort((oneString, anotherString) => {
    let lcOneString = oneString.toLowerCase();
    let lcAnotherString = anotherString.toLowerCase();
    if (lcOneString === lcAnotherString)
    {
      return 0;
    }
    else
    {
      return lcOneString > lcAnotherString ? 1 : -1;
    }
  });
  return arr;
};
...
const sortByPrice = (arr) => {
  arr.sort((oneObj, anotherObj) => {
    return oneObj.price - anotherObj.price;
  })
  return arr;
};
...
const sortNumbersByLength = (arr) => {
  arr.sort((oneNum, anotherNum) => {
    let oneNumStr = `${oneNum}`;
    let anotherNumStr = `${anotherNum}`;
    return oneNumStr.length - anotherNumStr.length;
  });
  return arr;
};
...
const sortPeople = (arr) => {
  arr.sort((onePerson, anotherPerson) => {
    if (onePerson.lastName === anotherPerson.lastName)
    {
      return 0;
    }
    else
    {
      return onePerson.lastName > anotherPerson.lastName ? 1 : -1;
    }
  });
  return arr;
};
...
const sortPeopleBetter = (arr) => {
  arr.sort((onePerson, anotherPerson) => {
    if (onePerson.lastName === anotherPerson.lastName)
    {
      if (onePerson.firstName === anotherPerson.firstName)
      {
        return onePerson.age - anotherPerson.age;
      }
      return onePerson.firstName > anotherPerson.firstName ? 1 : -1;
    }
    else
    {
      return onePerson.lastName > anotherPerson.lastName ? 1 : -1;
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((oneMeeting, anotherMeeting) => {
    return weekdaySorter[oneMeeting.dayOfWeek.toLowerCase()] - weekdaySorter[anotherMeeting.dayOfWeek.toLowerCase()];
  });
  return arr;
};
...
const sortSchedule = (arr) => {
  ...
  arr.sort((oneMeeting, anotherMeeting) => {
    if (oneMeeting.dayOfWeek.toLowerCase() === anotherMeeting.dayOfWeek.toLowerCase())
    {
      let oneMeetingStart = Number(oneMeeting.start);
      let oneMeetingEnd = Number(oneMeeting.end);
      let anotherMeetingStart = Number(anotherMeeting.start);
      let anotherMeetingEnd = Number(anotherMeeting.end);
      if (oneMeetingStart === anotherMeetingStart)
      {
        return (oneMeetingEnd - oneMeetingStart) - (anotherMeetingEnd - anotherMeetingStart);
      }
      return oneMeetingStart - anotherMeetingStart;
    }
    else
    {
      return weekdaySorter[oneMeeting.dayOfWeek.toLowerCase()] - weekdaySorter[anotherMeeting.dayOfWeek.toLowerCase()];
